...
class KITTI(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../data/AsymKD/kitti/kitti2015', image_set='training'):
...
class KITTI2012(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../data/AsymKD/kitti/kitti2012', image_set='training'):
